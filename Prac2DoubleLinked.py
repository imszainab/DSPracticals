'''Practical 02 Implement Linked List. Include options for insertion, deletion and search of a
...
my_list = LinkedList()
my_list.add_head(l1)
my_list.add_tail('Ayesha')
my_list.add_tail('Amreen')
my_list.add_tail('Sameer')
...
my_list2.add_tail('Sumaiyya')
my_list2.add_tail('Anabiya')
my_list2.add_tail('Ali')
my_list.merge(my_list2)
my_list.get_previous_node_at(3).element
my_list.reverse_display()
my_list.search('Irfan')
